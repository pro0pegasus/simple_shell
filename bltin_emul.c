 ...
 * @info: The tructure contains potential args. Used to maintain
...
int _myexit(info_t *info)
{
	...
	if (info->argv[1])  /* If there is an exit arg */
	{
		...
		info->err_num = _errato(info->argv[1]);
		return (-2);
	}
	info->err_num = -1;
	return (-2);
...
/**
 * _mycd - It changes the curr directory of the process
...
/**
 * _myhelp - It changes the curr directory of the process
 * @info: The structure contains potential args. Used to maintain
 *          constant func prototype.
...
/**
 * help_flag_check - It checks if there is a valid flag on help built-in
 * @info: The struct containing commands from line
 * @arg: args entered when using help
